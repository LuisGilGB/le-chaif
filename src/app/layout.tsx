...
const RootLayout = ({
  ...
  <html lang="en">
    <body className={clsx('w-dvw min-h-dvh', fontSans.className)}>
    <header className="sticky top-0 z-10 bg-white bg-opacity-90 dark:bg-sky-900 flex items-center justify-center px-16 py-2 border-b border-sky-200 dark:border-sky-800 shadow-sm">
