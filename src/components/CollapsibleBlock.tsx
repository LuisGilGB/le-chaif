    ...
    <section className={cn('space-y-4', className)}>
      <header className="flex items-center justify-between">
        ...
        <CollapsibleTrigger asChild>
          <Button variant="ghost" size="sm" className="group hover:bg-sky-100 dark:hover:bg-sky-800">
            <ChevronDown className="size-4 text-sky-500 dark:text-sky-400 transition-transform group-data-[state=open]:rotate-180" />
